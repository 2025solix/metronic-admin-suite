...
const Analytics = () => {
  ...
  const kpiData = [
    { label: 'Total GMV', value: `₹${((paymentStats?.totalAmount || 0) / 100000).toFixed(1)}L`, change: '+15%', trend: 'up', icon: DollarSign },
    { label: 'Net Revenue', value: `₹${((paymentStats?.completedAmount || 0) / 100000).toFixed(2)}L`, change: '+12%', trend: 'up', icon: TrendingUp },
    { label: 'Active Workers', value: String(stats?.activeWorkers || 0), change: '+8%', trend: 'up', icon: Users },
    { label: 'Active Employers', value: String(stats?.activeUsers || 0), change: '+10%', trend: 'up', icon: Users },
    { label: 'Jobs Posted', value: String(stats?.activeWorks || 0), change: '+18%', trend: 'up', icon: Briefcase },
    { label: 'Jobs Completed', value: String(stats?.completedWorks || 0), change: '+14%', trend: 'up', icon: Clock },
    { label: 'Avg Job Value', value: `₹${paymentStats?.totalAmount && paymentStats?.total ? Math.round(paymentStats.totalAmount / paymentStats.total) : 0}`, change: '-3%', trend: 'down', icon: DollarSign },
    { label: 'Pending Payouts', value: `₹${((paymentStats?.pendingAmount || 0) / 1000).toFixed(0)}K`, change: '+5', trend: 'neutral', icon: Clock },
  ];
